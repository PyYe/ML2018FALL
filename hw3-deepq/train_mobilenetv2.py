...
def get_model_spec():
    ...
    """
    return {"model_name": "mobilenetv2", "pretrained": True, "arg_scope_dict": {}}
...
def get_eval_spec():
    ...
    """
    transform = lambda image: tf.image.resize_images(image, [200, 200])
...
def before_batch(train_history, validation_history):
    ...
    """
    global lr
    return {'feed_dict': {lr: 0.05}, 'batch_norm': 0.5, 'drop_out': 0.2}
...
def save_model_as(train_history, validation_history):
    ...
    """
    n_epoch = len(train_history)
    return ('save_dir_m_1_'+str(n_epoch))
